...
Examples:
    ...
    Traceback (most recent call last):
      ...
      File "ensembl-genomio/src/ensembl/io/genomio/schemas/json/validate.py", line 63,
      in schema_validator
        jsonschema.validate(instance=content, schema=schema)
      File ".venv/dev/lib/python3.12/site-packages/jsonschema/validators.py", line 1306, in validate
        raise error
