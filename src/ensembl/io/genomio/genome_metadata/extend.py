...
def amend_genome_metadata(
    ...
    """
    Args:
        genome_infile: Genome metadata following the `src/ensembl/io/genomio/data/schemas/genome.json`.
...
def main() -> None:
    ...
    parser.add_argument_src_path(
        "--genome_infile",
        required=True,
        help="Input genome metadata file (following src/ensembl/io/genomio/data/schemas/genome.json)",
    )
