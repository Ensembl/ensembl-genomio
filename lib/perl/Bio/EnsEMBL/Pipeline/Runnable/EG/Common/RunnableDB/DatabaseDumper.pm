...
Bio::EnsEMBL::Pipeline::Runnable::EG::Common::DatabaseDumper
...
package Bio::EnsEMBL::Pipeline::Runnable::EG::Common::RunnableDB::DatabaseDumper;
...
use base (
  ...
  'Bio::EnsEMBL::Pipeline::Runnable::EG::Common::RunnableDB::Base'
);
